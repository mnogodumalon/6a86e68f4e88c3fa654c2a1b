...
export default function VeranstaltungenDetailPage() {
  ...
  async function loadData() {
    setLoading(true);
    try {
      const [mainData, raeumeData] = await Promise.all([
  ...
  return (
    ...
    >
      ...
      <RecordSection title={t('details')} cols={2}>
        ...
        <RecordField label={fieldLabel('veranstaltungen', 'raum')} value={getRaeumeDisplayName(record.fields.raum)} format="text" />
      </RecordSection>
