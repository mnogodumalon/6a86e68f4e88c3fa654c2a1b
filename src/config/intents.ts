...
// <custom:intent-imports>
import { IconCoin, IconCalendarPlus } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/beitrag-erfassen', label: { de: 'Beitrag erfassen', en: 'Record payment' }, icon: IconCoin, description: 'Mitgliedsbeitrag in zwei Schritten anlegen und Zahlungsstatus setzen' },
  { path: '/intents/veranstaltung-planen', label: { de: 'Veranstaltung planen', en: 'Plan event' }, icon: IconCalendarPlus, description: 'Raum wählen und neue Veranstaltung mit allen Details anlegen' },
  // </custom:intents>
];
